...
/**
 * 評価済みの描画関数
 * @typedef {(ctx: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D, t: number, b: number, s: unknown, vw: number, vh: number) => void} RenderFunction
 */
...
/**
 * @typedef {import('./audio.js').TimelineAudioItem & { id: string }} TimelineAudioItemWithId
 */
 ...
 * @returns {TimelineAudioItemWithId}
 */
 ...
 * @property {(t: number, b: number, s: unknown) => void} logic
 * @property {number} start
 * @property {number} end
 */
 ...
 * @param {(t: number, b: number, s: unknown) => void} logic
 ...
 * @typedef {TimelineVisualItem<unknown> | TimelineAudioItemWithId | TimelineGlobalEffectItem | TimelineComputeItem} TimelineItem
 */

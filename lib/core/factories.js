...
/**
 * 評価済みの描画関数
 * @typedef {(ctx: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D, t: number, b: number, s: any, vw: number, vh: number) => void} RenderFunction
 */
 ...
 * @property {(t: number, b: number, s: any) => void} logic
 * @property {number} start
 * @property {number} end
 */
 ...
 * @param {(t: number, b: number, s: any) => void} logic
 ...
 * @typedef {TimelineVisualItem<any> | TimelineAudioItemWithId | TimelineGlobalEffectItem | TimelineComputeItem} TimelineItem
 */

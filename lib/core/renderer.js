...
export class Renderer {
  ...
  render(timeline, t, tempoManager, audioManager, fps) {
    ...
    for (const comp of computes) {
      ...
      /** @type {any} */ (comp.logic)(t, defaultBeat, spectrum, w, h);
    }

    // Visual要素の抽出とZ-index安定ソート
    /** @type {(import('./factories.js').TimelineVisualItem<any> & { _originalIndex: number })[]} */
    const visuals = /** @type {any} */ (
      timeline

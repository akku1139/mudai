 ...
 * @property {DynamicProp<CanvasFillStrokeStyles['fillStyle']>} [color]
 */

// TODO: props.name() したら evaluateProp された状態で出てくるようにする
/**
 * @template T
 * @typedef {BaseProps & { [K in keyof T]: DynamicProp<T[K]>}} RenderProps
 */
 ...
 * props: RenderProps<TProps> & { _w: number, _h: number },

...
/**
 * @typedef {Uint8Array | Float32Array | number[]} AudioSpectrum
 */
 ...
 * @returns {(props: BaseProps & TProps) => (ctx: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D, t: number, b: number, s: AudioSpectrum, vw: number, vh: number) => void}
 */
export function createComponent(renderLogic) {
  return (/** @type {BaseProps & TProps} */ props) => {
    ...
    return (/** @type {CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D} */ ctx, /** @type {number} */ t, /** @type {number} */ b, /** @type {AudioSpectrum} */ s, /** @type {number} */ vw, /** @type {number} */ vh) => {
      // シークやリセットを検知して状態を初期化

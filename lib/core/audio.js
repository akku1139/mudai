...
/**
 * TypeScriptの推論能力不足
 * @param {import('./factories.js').TimelineItem} el
 * @returns {el is import('./audio.js').TimelineAudioItem}
 */
const isAudioItem = (el) => el.type === 'audio';
...
export class AudioManager {
  ...
  play(t, timeline) {
    ...
    /** @type {TimelineAudioItem[]} */
    const audioItems = timeline.filter(isAudioItem).filter(el => el.end ? t < el.end : true);

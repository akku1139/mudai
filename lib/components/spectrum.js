...
export const spectrumObject = createComponent(
  (
    ctx,
    /** @type {import('../core/component.js').RenderProps<{ color: string }>} */props,
    /** @type {{ smoothedData: Float32Array }}*/state, t, b, s
  ) => {
    ...
    ctx.fillStyle = evaluateProp(props.color ?? '#ffffff', t, b);
